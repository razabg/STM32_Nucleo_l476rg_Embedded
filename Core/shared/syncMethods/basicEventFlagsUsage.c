...
//osThreadId_t waitForBitOneHandle;
//const osThreadAttr_t waitForBitOne_attributes = {
//  .name = "waitForBitOne",
//  .stack_size = 128 * 4,
//  .priority = (osPriority_t) osPriorityNormal,
//};
///* Definitions for delayTask */
//osThreadId_t waitForBitTwoHandle;
//const osThreadAttr_t waitForBitTwo_attributes = {
//  .name = "waitForBitTwo",
//  .stack_size = 128 * 4,
//  .priority = (osPriority_t) osPriorityNormal,
//};
//
//osThreadId_t waitForBitThreeHandle;
//const osThreadAttr_t waitForBitThree_attributes = {
//  .name = "waitForBitThree",
//  .stack_size = 128 * 4,
//  .priority = (osPriority_t) osPriorityNormal,
//};
...
//DHT_Data dht_data = {0};
//DHT_Handle *dht = NULL;
//osEventFlagsId_t delayFlags; //******************************** this the events flag ***********************************
//
//#define FLAG_TASK1  0x01   // bit 0
//#define FLAG_TASK2  0x02   // bit 1
...
//  for(;;)
//  {
//	  osEventFlagsWait(delayFlags, FLAG_DONE1 | FLAG_DONE2 | FLAG_DONE3,osFlagsWaitAll, osWaitForever);
//	  printf("SysTick: %lu ms\r\n", HAL_GetTick());
//
//	          // restart the cycle for all 3 delay tasks
//	  osEventFlagsSet(delayFlags, FLAG_TASK1 | FLAG_TASK2 | FLAG_TASK3);
//
//
//  }
