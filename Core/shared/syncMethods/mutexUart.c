...
//};
///* Definitions for printStar */
//osThreadId_t printStarHandle;
//const osThreadAttr_t printStar_attributes = {
//  .name = "printStar",
//  .stack_size = 512 * 4,
//  .priority = (osPriority_t) osPriorityNormal,
//};
///* Definitions for printDash */
//osThreadId_t printDashHandle;
//const osThreadAttr_t printDash_attributes = {
//  .name = "printDash",
//  .stack_size = 512 * 4,
//  .priority = (osPriority_t) osPriorityLow,
//};
///* Definitions for printSlash */
//osThreadId_t printSlashHandle;
//const osThreadAttr_t printSlash_attributes = {
//  .name = "printSlash",
//  .stack_size = 512 * 4,
...
//
//  /* creation of printStar */
//  printStarHandle = osThreadNew(StartStar, NULL, &printStar_attributes);
//
//  /* creation of printDash */
//  printDashHandle = osThreadNew(StartDash, NULL, &printDash_attributes);
//
//  /* creation of printSlash */
//  printSlashHandle = osThreadNew(StartSlash, NULL, &printSlash_attributes);
//
...
//}
//
///* USER CODE BEGIN Header_StartStar */
///**
//* @brief Function implementing the printStar thread.
//* @param argument: Not used
//* @retval None
//*/
///* USER CODE END Header_StartStar */
//void StartStar(void *argument)
//{
//  /* USER CODE BEGIN StartStar */
//  /* Infinite loop */
//  for(;;)
//  {
...
//  }
//  /* USER CODE END StartStar */
//}
//
///* USER CODE BEGIN Header_StartDash */
///**
//* @brief Function implementing the printDash thread.
//* @param argument: Not used
//* @retval None
//*/
///* USER CODE END Header_StartDash */
//void StartDash(void *argument)
//{
//  /* USER CODE BEGIN StartDash */
//  /* Infinite loop */
//  for(;;)
//  {
//	  int delay =  10 + rand() % (99 - 10 + 1);
...
//	  osMutexRelease(UartMutexHandle);
//  }
//  /* USER CODE END StartDash */
//}
//
///* USER CODE BEGIN Header_StartSlash */
///**
//* @brief Function implementing the printSlash thread.
//* @param argument: Not used
//* @retval None
//*/
///* USER CODE END Header_StartSlash */
//void StartSlash(void *argument)
//{
//  /* USER CODE BEGIN StartSlash */
//  /* Infinite loop */
//  for(;;)
//  {
//	  int delay =  10 + rand() % (99 - 10 + 1);
