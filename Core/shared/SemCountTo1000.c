...
//};
///* Definitions for OddTask */
//osThreadId_t OddTaskHandle;
//const osThreadAttr_t OddTask_attributes = {
//  .name = "OddTask",
//  .stack_size = 128 * 4,
//  .priority = (osPriority_t) osPriorityLow,
//};
///* Definitions for EvenTask */
//osThreadId_t EvenTaskHandle;
//const osThreadAttr_t EvenTask_attributes = {
//  .name = "EvenTask",
//  .stack_size = 128 * 4,
//  .priority = (osPriority_t) osPriorityLow,
//};
...
//void Odd(void *argument);
//void Even(void *argument);
//
///* USER CODE BEGIN PFP */
//
///* USER CODE END PFP */
...
//
//  /* creation of OddTask */
//  OddTaskHandle = osThreadNew(Odd, NULL, &OddTask_attributes);
//
//  /* creation of EvenTask */
//  EvenTaskHandle = osThreadNew(Even, NULL, &EvenTask_attributes);
//
...
//}
//
///* USER CODE BEGIN Header_Odd */
///**
//* @brief Function implementing the OddTask thread.
//* @param argument: Not used
//* @retval None
//*/
///* USER CODE END Header_Odd */
