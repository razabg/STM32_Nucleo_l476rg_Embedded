...
/*
 * code to insert in main to check the timertask:
 * TimerTasks *tts = NULL;//timertasks object
  tts = TimerTasks_create();
  TimerTasks_registerCallback(tts, Periodic_LedToggle_Callback, &blue_task, 300);
  TimerTasks_registerCallback(tts, Periodic_LedToggle_Callback, &red_task, 1000);
  TimerTasks_registerCallback(tts, Periodic_PrintCounters_Callback, NULL, 3000);
 *
 */
